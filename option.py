...
parser.add_argument('--scale', type=str, default='3',  #OLI2MSI:3 Alsat: 4
                    help='super resolution scale')
parser.add_argument('--patch_size', type=int, default=96,  #OLI2MSI:96 Alsat:128
...
# Log specifications
parser.add_argument('--save', type=str, default='test_model',
...
parser.add_argument('--save_gt', default=True,
                    help='save low-resolution and high-resolution images together')


##############change the option below
parser.add_argument('--use_rrdb', type=bool, default=True)
